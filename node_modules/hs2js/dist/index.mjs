    ...
    class Parser {
      ...
      static init(moduleOptions) {
        return initPromise || (Module = Object.assign({}, Module, moduleOptions), initPromise = new Promise((resolveInitPromise) => {
          var moduleOverrides = Object.assign({}, Module), arguments_ = [], thisProgram = "./this.program", quit_ = (t, e) => {
            throw e;
          ...
          if (ENVIRONMENT_IS_NODE) {
            var fs = require$$0, nodePath = require$$0;
            scriptDirectory = ENVIRONMENT_IS_WORKER ? nodePath.dirname(scriptDirectory) + "/" : __dirname + "/", read_ = (t, e) => (t = isFileURI(t) ? new URL(t) : nodePath.normalize(t), fs.readFileSync(t, e ? void 0 : "utf8")), readBinary = (t) => {
              var e = read_(t, !0);
              return e.buffer || (e = new Uint8Array(e)), e;
            }, readAsync = (t, e, r) => {
              t = isFileURI(t) ? new URL(t) : nodePath.normalize(t), fs.readFile(t, function(n, a) {
                n ? r(n) : e(a.buffer);
              });
            }, process.argv.length > 1 && (thisProgram = process.argv[1].replace(/\\/g, "/")), arguments_ = process.argv.slice(2), module.exports = Module, quit_ = (t, e) => {
              if (keepRuntimeAlive())
            ...
            (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) && (ENVIRONMENT_IS_WORKER ? scriptDirectory = self.location.href : document !== void 0 && document.currentScript && (scriptDirectory = document.currentScript.src), scriptDirectory = scriptDirectory.indexOf("blob:") !== 0 ? scriptDirectory.substr(0, scriptDirectory.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", read_ = (t) => {
              var e = new XMLHttpRequest();
              return e.open("GET", t, !1), e.send(null), e.responseText;
            }, ENVIRONMENT_IS_WORKER && (readBinary = (t) => {
              var e = new XMLHttpRequest();
          ...
          var ABORT = !1, EXITSTATUS, UTF8Decoder = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, buffer, HEAP8, HEAPU8, HEAP16, HEAP32, HEAPU32, HEAPF32, HEAPF64;
          function UTF8ArrayToString(t, e, r) {
            for (var n = e + r, a = e; t[a] && !(a >= n); )
              ++a;
            if (a - e > 16 && t.buffer && UTF8Decoder)
              return UTF8Decoder.decode(t.subarray(e, a));
            for (var s = ""; e < a; ) {
              var _ = t[e++];
              if (128 & _) {
                var o = 63 & t[e++];
                if ((224 & _) != 192) {
                  var d = 63 & t[e++];
                  if ((_ = (240 & _) == 224 ? (15 & _) << 12 | o << 6 | d : (7 & _) << 18 | o << 12 | d << 6 | 63 & t[e++]) < 65536)
                  ...
                  s += String.fromCharCode((31 & _) << 6 | o);
              } else
                s += String.fromCharCode(_);
            }
            return s;
          ...
          function stringToUTF8Array(t, e, r, n) {
            if (!(n > 0))
              return 0;
            for (var a = r, s = r + n - 1, _ = 0; _ < t.length; ++_) {
              var o = t.charCodeAt(_);
              if (o >= 55296 && o <= 57343 && (o = 65536 + ((1023 & o) << 10) | 1023 & t.charCodeAt(++_)), o <= 127) {
                if (r >= s)
                  break;
                e[r++] = o;
              } else if (o <= 2047) {
          ...
          function updateGlobalBufferAndViews(t) {
            buffer = t, Module.HEAP8 = HEAP8 = new Int8Array(t), Module.HEAP16 = HEAP16 = new Int16Array(t), Module.HEAP32 = HEAP32 = new Int32Array(t), Module.HEAPU8 = HEAPU8 = new Uint8Array(t), Module.HEAPU16 = new Uint16Array(t), Module.HEAPU32 = HEAPU32 = new Uint32Array(t), Module.HEAPF32 = HEAPF32 = new Float32Array(t), Module.HEAPF64 = HEAPF64 = new Float64Array(t);
          }
          ...
          var wasmTable = new WebAssembly.Table({ initial: 20, element: "anyfunc" }), __ATPRERUN__ = [], __ATINIT__ = [], __ATMAIN__ = [], __ATPOSTRUN__ = [], __RELOC_FUNCS__ = [], runtimeInitialized = !1;
          ...
          function abort(t) {
            throw Module.onAbort && Module.onAbort(t), err(t = "Aborted(" + t + ")"), ABORT = !0, EXITSTATUS = 1, t += ". Build with -sASSERTIONS for more info.", new WebAssembly.RuntimeError(t);
          }
          ...
          function getBinaryPromise() {
            if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER)) {
              if (typeof fetch == "function" && !isFileURI(wasmBinaryFile))
                return fetch(wasmBinaryFile, { credentials: "same-origin" }).then(function(t) {
                  if (!t.ok)
          ...
          function createWasm() {
            var t = { env: asmLibraryArg, wasi_snapshot_preview1: asmLibraryArg, "GOT.mem": new Proxy(asmLibraryArg, GOTHandler), "GOT.func": new Proxy(asmLibraryArg, GOTHandler) };
            function e(a, s) {
              var _ = a.exports;
              _ = relocateExports(_, 1024);
              var o = getDylinkMetadata(s);
              o.neededDynlibs && (dynamicLibraries = o.neededDynlibs.concat(dynamicLibraries)), mergeLibSymbols(_), Module.asm = _, addOnInit(Module.asm.__wasm_call_ctors), __RELOC_FUNCS__.push(Module.asm.__wasm_apply_data_relocs), removeRunDependency();
            }
            function r(a) {
              e(a.instance, a.module);
            }
            function n(a) {
              return getBinaryPromise().then(function(s) {
            ...
            return wasmBinary || typeof WebAssembly.instantiateStreaming != "function" || isDataURI(wasmBinaryFile) || isFileURI(wasmBinaryFile) || ENVIRONMENT_IS_NODE || typeof fetch != "function" ? n(r) : fetch(wasmBinaryFile, { credentials: "same-origin" }).then(function(a) {
              return WebAssembly.instantiateStreaming(a, t).then(r, function(s) {
                return err("wasm streaming compile failed: " + s), err("falling back to ArrayBuffer instantiation"), n(r);
              });
            }), {};
          }
          ...
          var GOT = {}, CurrentModuleWeakSymbols = /* @__PURE__ */ new Set([]), GOTHandler = { get: function(t, e) {
            var r = GOT[e];
            return r || (r = GOT[e] = new WebAssembly.Global({ value: "i32", mutable: !0 })), CurrentModuleWeakSymbols.has(e) || (r.required = !0), r;
          } };
          ...
          function getDylinkMetadata(t) {
            ...
            if (t instanceof WebAssembly.Module) {
              var o = WebAssembly.Module.customSections(t, _);
              o.length === 0 && (_ = "dylink", o = WebAssembly.Module.customSections(t, _)), s(o.length === 0, "need dylink section"), r = (t = new Uint8Array(o[0])).length;
            } else {
              s(new Uint32Array(new Uint8Array(t.subarray(0, 24)).buffer)[0] != 1836278016, "need to see wasm magic number"), s(t[8] !== 0, "need the dylink section to be first"), e = 9;
              var d = n();
              r = e + d, _ = a();
            }
            var u = { neededDynlibs: [], tlsExports: /* @__PURE__ */ new Set(), weakImports: /* @__PURE__ */ new Set() };
            if (_ == "dylink") {
              u.memorySize = n(), u.memoryAlign = n(), u.tableSize = n(), u.tableAlign = n();
              for (var c = n(), m = 0; m < c; ++m) {
                var y = a();
                u.neededDynlibs.push(y);
              }
            } else
              for (s(_ !== "dylink.0"); e < r; ) {
                var h = t[e++], E = n();
                if (h === 1)
                  u.memorySize = n(), u.memoryAlign = n(), u.tableSize = n(), u.tableAlign = n();
                else if (h === 2)
                  for (c = n(), m = 0; m < c; ++m)
                    y = a(), u.neededDynlibs.push(y);
                else if (h === 3)
                  for (var i = n(); i--; ) {
                    var p = a();
                    256 & n() && u.tlsExports.add(p);
                  }
                else if (h === 4)
                  for (i = n(); i--; )
                    a(), p = a(), (3 & n()) == 1 && u.weakImports.add(p);
                else
                  e += E;
              }
            return u;
          ...
          function asmjsMangle(t) {
            return t.indexOf("dynCall_") == 0 || ["stackAlloc", "stackSave", "stackRestore", "getTempRet0", "setTempRet0"].includes(t) ? t : "_" + t;
          }
          ...
          function getWasmTableEntry(t) {
            ...
            return e || (t >= wasmTableMirror.length && (wasmTableMirror.length = t + 1), wasmTableMirror[t] = e = wasmTable.get(t)), e;
          }
          ...
          function getMemory(t) {
            ...
            var e = ___heap_base, r = e + t + 15 & -16;
          ...
          function sigToWasmTypes(t) {
            for (var e = { i: "i32", j: "i32", f: "f32", d: "f64", p: "i32" }, r = { parameters: [], results: t[0] == "v" ? [] : [e[t[0]]] }, n = 1; n < t.length; ++n)
              r.parameters.push(e[t[n]]), t[n] === "j" && r.parameters.push("i32");
            return r;
          }
          function generateFuncType(t, e) {
            var r = t.slice(0, 1), n = t.slice(1), a = { i: 127, p: 127, j: 126, f: 125, d: 124 };
            e.push(96), uleb128Encode(n.length, e);
            for (var s = 0; s < n.length; ++s)
              e.push(a[n[s]]);
            r == "v" ? e.push(0) : e.push(1, a[r]);
          }
          function convertJsFunctionToWasm(t, e) {
            ...
            uleb128Encode(r.length, n), n.push.apply(n, r), n.push(2, 7, 1, 1, 101, 1, 102, 0, 0, 7, 5, 1, 1, 102, 0, 0);
            var a = new WebAssembly.Module(new Uint8Array(n));
            return new WebAssembly.Instance(a, { e: { f: t } }).exports.f;
          }
          ...
          function addFunction(t, e) {
            if (functionsInTableMap || (functionsInTableMap = /* @__PURE__ */ new WeakMap(), updateTableMap(0, wasmTable.length)), functionsInTableMap.has(t))
          ...
          function updateGOT(t, e) {
            for (var r in t)
              if (!isInternalSym(r)) {
                var n = t[r];
                r.startsWith("orig$") && (r = r.split("$")[1], e = !0), GOT[r] || (GOT[r] = new WebAssembly.Global({ value: "i32", mutable: !0 })), (e || GOT[r].value == 0) && (typeof n == "function" ? GOT[r].value = addFunction(n) : typeof n == "number" ? GOT[r].value = n : err("unhandled export type for `" + r + "`: " + typeof n));
              }
          }
          function relocateExports(t, e, r) {
            ...
            for (var a in t) {
              var s = t[a];
              typeof s == "object" && (s = s.value), typeof s == "number" && (s += e), n[a] = s;
            }
            return updateGOT(n, r), n;
          }
          function resolveGlobalSymbol(t, e) {
            var r;
            return e && (r = asmLibraryArg["orig$" + t]), r || (r = asmLibraryArg[t]) && r.stub && (r = void 0), r || (r = Module[asmjsMangle(t)]), !r && t.startsWith("invoke_") && (r = createInvokeFunction(t.split("_")[1])), r;
          }
          ...
          function loadWebAssemblyModule(binary, flags, handle) {
            ...
            function loadModule() {
              ...
              var proxyHandler = { get: function(t, e) {
                switch (e) {
                  case "__memory_base":
                    return memoryBase;
                  case "__table_base":
            ...
            return CurrentModuleWeakSymbols = metadata.weakImports, flags.loadAsync ? metadata.neededDynlibs.reduce(function(t, e) {
          ...
          function loadDynamicLibrary(t, e, r) {
            ...
            if (n)
              return e.global && !n.global && (n.global = !0, n.module !== "loading" && mergeLibSymbols(n.module)), e.nodelete && n.refcount !== 1 / 0 && (n.refcount = 1 / 0), n.refcount++, r && (LDSO.loadedLibsByHandle[r] = n), !e.loadAsync || Promise.resolve(!0);
            function a(o) {
              if (e.fs && e.fs.findObject(o)) {
                var d = e.fs.readFile(o, { encoding: "binary" });
                return d instanceof Uint8Array || (d = new Uint8Array(d)), e.loadAsync ? Promise.resolve(d) : d;
              }
              if (o = locateFile(o), e.loadAsync)
                return new Promise(function(u, c) {
                  readAsync(o, (m) => u(new Uint8Array(m)), c);
                });
              if (!readBinary)
            ...
            function s() {
              ...
              return e.loadAsync ? a(t).then(function(d) {
                return loadWebAssemblyModule(d, e, r);
              }) : loadWebAssemblyModule(a(t), e, r);
            }
            function _(o) {
              n.global && mergeLibSymbols(o), n.module = o;
            }
            return n = { refcount: e.nodelete ? 1 / 0 : 1, name: t, module: "loading", global: e.global }, LDSO.loadedLibsByName[t] = n, r && (LDSO.loadedLibsByHandle[r] = n), e.loadAsync ? s().then(function(o) {
              return _(o), !0;
            }) : (_(s()), !0);
          }
          ...
          function preloadDylibs() {
            dynamicLibraries.length ? (addRunDependency(), dynamicLibraries.reduce(function(t, e) {
              return t.then(function() {
          ...
          function setValue(t, e, r = "i8") {
            switch (r.endsWith("*") && (r = "*"), r) {
              ...
              case "i32":
                ...
                break;
              case "i64":
                tempI64 = [e >>> 0, (tempDouble = e, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (0 | Math.min(+Math.floor(tempDouble / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[t >> 2] = tempI64[0], HEAP32[t + 4 >> 2] = tempI64[1];
                break;
              case "float":
                HEAPF32[t >> 2] = e;
                break;
          ...
          var ___memory_base = new WebAssembly.Global({ value: "i32", mutable: !1 }, 1024), ___stack_pointer = new WebAssembly.Global({ value: "i32", mutable: !0 }, 78144), ___table_base = new WebAssembly.Global({ value: "i32", mutable: !1 }, 1), nowIsMonotonic = !0, _emscripten_get_now;
          ...
          function emscripten_realloc_buffer(t) {
            try {
              return wasmMemory.grow(t - buffer.byteLength + 65535 >>> 16), updateGlobalBufferAndViews(wasmMemory.buffer), 1;
            } catch {
            }
          }
          function _emscripten_resize_heap(t) {
            ...
            for (var n = 1; n <= 4; n *= 2) {
              var a = e * (1 + 0.2 / n);
              if (a = Math.min(a, t + 100663296), emscripten_realloc_buffer(Math.min(r, (s = Math.max(t, a)) + ((_ = 65536) - s % _) % _)))
                return !0;
            }
            var s, _;
            return !1;
          }
          __emscripten_get_now_is_monotonic.sig = "i", Module._abort = _abort, _abort.sig = "v", _emscripten_get_now = ENVIRONMENT_IS_NODE ? () => {
            var t = process.hrtime();
            return 1e3 * t[0] + t[1] / 1e6;
          } : () => performance.now(), _emscripten_get_now.sig = "d", _emscripten_memcpy_big.sig = "vppp", _emscripten_resize_heap.sig = "ip";
          var SYSCALLS = { DEFAULT_POLLMASK: 5, calculateAt: function(t, e, r) {
            if (PATH.isAbs(e))
              return e;
            var n;
            ...
            HEAP32[r >> 2] = n.dev, HEAP32[r + 8 >> 2] = n.ino, HEAP32[r + 12 >> 2] = n.mode, HEAPU32[r + 16 >> 2] = n.nlink, HEAP32[r + 20 >> 2] = n.uid, HEAP32[r + 24 >> 2] = n.gid, HEAP32[r + 28 >> 2] = n.rdev, tempI64 = [n.size >>> 0, (tempDouble = n.size, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (0 | Math.min(+Math.floor(tempDouble / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[r + 40 >> 2] = tempI64[0], HEAP32[r + 44 >> 2] = tempI64[1], HEAP32[r + 48 >> 2] = 4096, HEAP32[r + 52 >> 2] = n.blocks;
            var a = n.atime.getTime(), s = n.mtime.getTime(), _ = n.ctime.getTime();
            return tempI64 = [Math.floor(a / 1e3) >>> 0, (tempDouble = Math.floor(a / 1e3), +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (0 | Math.min(+Math.floor(tempDouble / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[r + 56 >> 2] = tempI64[0], HEAP32[r + 60 >> 2] = tempI64[1], HEAPU32[r + 64 >> 2] = a % 1e3 * 1e3, tempI64 = [Math.floor(s / 1e3) >>> 0, (tempDouble = Math.floor(s / 1e3), +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (0 | Math.min(+Math.floor(tempDouble / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[r + 72 >> 2] = tempI64[0], HEAP32[r + 76 >> 2] = tempI64[1], HEAPU32[r + 80 >> 2] = s % 1e3 * 1e3, tempI64 = [Math.floor(_ / 1e3) >>> 0, (tempDouble = Math.floor(_ / 1e3), +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (0 | Math.min(+Math.floor(tempDouble / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[r + 88 >> 2] = tempI64[0], HEAP32[r + 92 >> 2] = tempI64[1], HEAPU32[r + 96 >> 2] = _ % 1e3 * 1e3, tempI64 = [n.ino >>> 0, (tempDouble = n.ino, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (0 | Math.min(+Math.floor(tempDouble / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[r + 104 >> 2] = tempI64[0], HEAP32[r + 108 >> 2] = tempI64[1], 0;
          }, doMsync: function(t, e, r, n, a) {
            if (!FS.isFile(e.node.mode))
              throw new FS.ErrnoError(43);
            if (2 & n)
              return 0;
            var s = HEAPU8.slice(t, t + r);
            FS.msync(e, s, a, r, n);
          ...
          function _proc_exit(t) {
            EXITSTATUS = t, keepRuntimeAlive() || (Module.onExit && Module.onExit(t), ABORT = !0), quit_(t, new ExitStatus(t));
          }
          function exitJS(t, e) {
          ...
          function _fd_close(t) {
            try {
              ...
              if (typeof FS > "u" || !(r instanceof FS.ErrnoError))
                throw r;
              return r.errno;
            }
          }
          ...
          function _fd_seek(t, e, r, n, a) {
            try {
              var s = convertI32PairToI53Checked(e, r);
              if (isNaN(s))
                return 61;
              var _ = SYSCALLS.getStreamFromFD(t);
              return FS.llseek(_, s, n), tempI64 = [_.position >>> 0, (tempDouble = _.position, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (0 | Math.min(+Math.floor(tempDouble / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[a >> 2] = tempI64[0], HEAP32[a + 4 >> 2] = tempI64[1], _.getdents && s === 0 && n === 0 && (_.getdents = null), 0;
            } catch (o) {
              if (typeof FS > "u" || !(o instanceof FS.ErrnoError))
                throw o;
              return o.errno;
            }
          }
          function doWritev(t, e, r, n) {
            for (var a = 0, s = 0; s < r; s++) {
              var _ = HEAPU32[e >> 2], o = HEAPU32[e + 4 >> 2];
              e += 8;
              var d = FS.write(t, HEAP8, _, o, n);
              if (d < 0)
                return -1;
              a += d, n !== void 0 && (n += d);
            }
          ...
          function _fd_write(t, e, r, n) {
            try {
              var a = doWritev(SYSCALLS.getStreamFromFD(t), e, r);
              return HEAPU32[n >> 2] = a, 0;
            } catch (s) {
              if (typeof FS > "u" || !(s instanceof FS.ErrnoError))
                throw s;
              return s.errno;
            }
          }
          function _tree_sitter_log_callback(t, e) {
            if (currentLogCallback) {
              const r = UTF8ToString(e);
              currentLogCallback(r, t !== 0);
            }
          }
          function _tree_sitter_parse_callback(t, e, r, n, a) {
            var s = currentParseCallback(e, { row: r, column: n });
            typeof s == "string" ? (setValue(a, s.length, "i32"), stringToUTF16(s, t, 10240)) : setValue(a, 0, "i32");
          }
          ...
          createWasm(), Module.___wasm_call_ctors = function() {
            ...
            return (Module.___wasm_apply_data_relocs = Module.asm.__wasm_apply_data_relocs).apply(null, arguments);
          };
          ...
          }, Module.___cxa_atexit = function() {
            return (Module.___cxa_atexit = Module.asm.__cxa_atexit).apply(null, arguments);
          ...
          Module.__Znwm = function() {
            ...
            return (Module.__ZNSt3__212basic_stringIwNS_11char_traitsIwEENS_9allocatorIwEEE6resizeEmw = Module.asm._ZNSt3__212basic_stringIwNS_11char_traitsIwEENS_9allocatorIwEEE6resizeEmw).apply(null, arguments);
          ...
          function callMain(t) {
            ...
            if (e) {
              ...
              var r = t.length, n = stackAlloc(4 * (r + 1)), a = n >> 2;
              t.forEach((_) => {
                HEAP32[a++] = allocateUTF8OnStack(_);
              }), HEAP32[a] = 0;
              try {
                var s = e(r, n);
                return exitJS(s, !0), s;
              } catch (_) {
                return handleException(_);
              }
            }
          }
          Module.AsciiToString = AsciiToString, Module.stringToUTF16 = stringToUTF16, dependenciesFulfilled = function t() {
            calledRun || run(), calledRun || (dependenciesFulfilled = t);
          };
          var dylibsLoaded = !1;
          function run(t) {
            function e() {
              calledRun || (calledRun = !0, Module.calledRun = !0, ABORT || (initRuntime(), preMain(), Module.onRuntimeInitialized && Module.onRuntimeInitialized(), shouldRunNow && callMain(t), postRun()));
            }
            t = t || arguments_, runDependencies > 0 || !dylibsLoaded && (preloadDylibs(), dylibsLoaded = !0, runDependencies > 0) || (preRun(), runDependencies > 0 || (Module.setStatus ? (Module.setStatus("Running..."), setTimeout(function() {
              setTimeout(function() {
                Module.setStatus("");
              }, 1), e();
            }, 1)) : e()));
          ...
          class ParserImpl {
            ...
            setLanguage(e) {
              ...
              if (e) {
                ...
                {
                  r = e[0];
                  const n = C._ts_language_version(r);
            ...
            parse(e, r, n) {
              if (typeof e == "string")
                currentParseCallback = (d, u, c) => e.slice(d, c);
              else {
                if (typeof e != "function")
              ...
              if (n && n.includedRanges) {
                a = n.includedRanges.length, s = C._calloc(a, SIZE_OF_RANGE);
                let d = s;
                for (let u = 0; u < a; u++)
                  marshalRange(d, n.includedRanges[u]), d += SIZE_OF_RANGE;
              }
              const _ = C._ts_parser_parse_wasm(this[0], this[1], r ? r[0] : 0, s, a);
              if (!_)
                throw currentParseCallback = null, currentLogCallback = null, new Error("Parsing failed");
              const o = new Tree(INTERNAL, _, this.language, currentParseCallback);
          ...
          class Tree {
            constructor(e, r, n, a) {
              assertInternal(e), this[0] = r, this.language = n, this.textCallback = a;
            }
            copy() {
            ...
            getChangedRanges(e) {
              ...
              const r = getValue(TRANSFER_BUFFER, "i32"), n = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32"), a = new Array(r);
              if (r > 0) {
                let s = n;
                for (let _ = 0; _ < r; _++)
                  a[_] = unmarshalRange(s), s += SIZE_OF_RANGE;
                C._free(n);
              }
              return a;
            }
          ...
          class Node {
            ...
            childForFieldName(e) {
              const r = this.tree.language.fields.indexOf(e);
              if (r !== -1)
            ...
            get children() {
              if (!this._children) {
                ...
                const e = getValue(TRANSFER_BUFFER, "i32"), r = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32");
                if (this._children = new Array(e), e > 0) {
                  let n = r;
                  for (let a = 0; a < e; a++)
                    this._children[a] = unmarshalNode(this.tree, n), n += SIZE_OF_NODE;
                  C._free(r);
                }
              }
            ...
            get namedChildren() {
              if (!this._namedChildren) {
                ...
                if (this._namedChildren = new Array(e), e > 0) {
                  let n = r;
                  for (let a = 0; a < e; a++)
                    this._namedChildren[a] = unmarshalNode(this.tree, n), n += SIZE_OF_NODE;
                  C._free(r);
                }
              }
            ...
            descendantsOfType(e, r, n) {
              ...
              const a = [], s = this.tree.language.types;
              for (let c = 0, m = s.length; c < m; c++)
                e.includes(s[c]) && a.push(c);
              const _ = C._malloc(SIZE_OF_INT * a.length);
              for (let c = 0, m = a.length; c < m; c++)
                setValue(_ + c * SIZE_OF_INT, a[c], "i32");
              marshalNode(this), C._ts_node_descendants_of_type_wasm(this.tree[0], _, a.length, r.row, r.column, n.row, n.column);
              const o = getValue(TRANSFER_BUFFER, "i32"), d = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32"), u = new Array(o);
              if (o > 0) {
                let c = d;
                for (let m = 0; m < o; m++)
                  u[m] = unmarshalNode(this.tree, c), c += SIZE_OF_NODE;
              }
              return C._free(d), C._free(_), u;
            }
            get nextSibling() {
            ...
            descendantForIndex(e, r = e) {
              ...
              return setValue(n, e, "i32"), setValue(n + SIZE_OF_INT, r, "i32"), C._ts_node_descendant_for_index_wasm(this.tree[0]), unmarshalNode(this.tree);
            }
            namedDescendantForIndex(e, r = e) {
              ...
              marshalNode(this);
              let n = TRANSFER_BUFFER + SIZE_OF_NODE;
              return setValue(n, e, "i32"), setValue(n + SIZE_OF_INT, r, "i32"), C._ts_node_named_descendant_for_index_wasm(this.tree[0]), unmarshalNode(this.tree);
            }
            descendantForPosition(e, r = e) {
              if (!isPoint(e) || !isPoint(r))
                throw new Error("Arguments must be {row, column} objects");
              marshalNode(this);
              let n = TRANSFER_BUFFER + SIZE_OF_NODE;
              return marshalPoint(n, e), marshalPoint(n + SIZE_OF_POINT, r), C._ts_node_descendant_for_position_wasm(this.tree[0]), unmarshalNode(this.tree);
            }
            namedDescendantForPosition(e, r = e) {
              ...
              marshalNode(this);
              let n = TRANSFER_BUFFER + SIZE_OF_NODE;
              return marshalPoint(n, e), marshalPoint(n + SIZE_OF_POINT, r), C._ts_node_named_descendant_for_position_wasm(this.tree[0]), unmarshalNode(this.tree);
            }
            walk() {
            ...
            toString() {
              marshalNode(this);
              const e = C._ts_node_to_string_wasm(this.tree[0]), r = AsciiToString(e);
              return C._free(e), r;
            }
          }
          class TreeCursor {
            ...
            get nodeText() {
              ...
              const e = C._ts_tree_cursor_start_index_wasm(this.tree[0]), r = C._ts_tree_cursor_end_index_wasm(this.tree[0]);
          ...
          class Language {
            constructor(e, r) {
              ...
              for (let n = 0, a = this.types.length; n < a; n++)
                C._ts_language_symbol_type(this[0], n) < 2 && (this.types[n] = UTF8ToString(C._ts_language_symbol_name(this[0], n)));
              this.fields = new Array(C._ts_language_field_count(this[0]) + 1);
              for (let n = 0, a = this.fields.length; n < a; n++) {
                const s = C._ts_language_field_name_for_id(this[0], n);
                this.fields[n] = s !== 0 ? UTF8ToString(s) : null;
              }
            }
            get version() {
            ...
            idForNodeType(e, r) {
              const n = lengthBytesUTF8(e), a = C._malloc(n + 1);
              stringToUTF8(e, a, n + 1);
              const s = C._ts_language_symbol_for_name(this[0], a, n, r);
              return C._free(a), s || null;
            }
            get nodeTypeCount() {
              return C._ts_language_symbol_count(this[0]);
            }
            nodeTypeForId(e) {
              const r = C._ts_language_symbol_name(this[0], e);
            ...
            query(e) {
              ...
              const a = C._ts_query_new(this[0], n, r, TRANSFER_BUFFER, TRANSFER_BUFFER + SIZE_OF_INT);
              if (!a) {
                const i = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32"), p = UTF8ToString(n, getValue(TRANSFER_BUFFER, "i32")).length, f = e.substr(p, 100).split(`
`)[0];
                let l, g = f.match(QUERY_WORD_REGEX)[0];
                switch (i) {
                  case 2:
                    l = new RangeError(`Bad node name '${g}'`);
                    break;
                  case 3:
                    l = new RangeError(`Bad field name '${g}'`);
                    break;
                  case 4:
                    l = new RangeError(`Bad capture name @${g}`);
                    break;
                  case 5:
                    l = new TypeError(`Bad pattern structure at offset ${p}: '${f}'...`), g = "";
                    break;
                  default:
                    l = new SyntaxError(`Bad syntax at offset ${p}: '${f}'...`), g = "";
                }
                throw l.index = p, l.length = g.length, C._free(n), l;
              }
              const s = C._ts_query_string_count(a), _ = C._ts_query_capture_count(a), o = C._ts_query_pattern_count(a), d = new Array(_), u = new Array(s);
              for (let i = 0; i < _; i++) {
                const p = C._ts_query_capture_name_for_id(a, i, TRANSFER_BUFFER), f = getValue(TRANSFER_BUFFER, "i32");
                d[i] = UTF8ToString(p, f);
              }
              for (let i = 0; i < s; i++) {
                const p = C._ts_query_string_value_for_id(a, i, TRANSFER_BUFFER), f = getValue(TRANSFER_BUFFER, "i32");
                u[i] = UTF8ToString(p, f);
              }
              const c = new Array(o), m = new Array(o), y = new Array(o), h = new Array(o), E = new Array(o);
              for (let i = 0; i < o; i++) {
                const p = C._ts_query_predicates_for_pattern(a, i, TRANSFER_BUFFER), f = getValue(TRANSFER_BUFFER, "i32");
                h[i] = [], E[i] = [];
                const l = [];
                let g = p;
                for (let b = 0; b < f; b++) {
                  const N = getValue(g, "i32");
                  g += SIZE_OF_INT;
                  const P = getValue(g, "i32");
                  if (g += SIZE_OF_INT, N === PREDICATE_STEP_TYPE_CAPTURE)
                    l.push({ type: "capture", name: d[P] });
                  else if (N === PREDICATE_STEP_TYPE_STRING)
                    l.push({ type: "string", value: u[P] });
                  else if (l.length > 0) {
                    if (l[0].type !== "string")
                    ...
                    switch (S) {
                      ...
                      case "eq?":
                        if (l.length !== 3)
                          throw new Error("Wrong number of arguments to `#eq?` predicate. Expected 2, got " + (l.length - 1));
                        if (l[1].type !== "capture")
                          throw new Error(`First argument of \`#eq?\` predicate must be a capture. Got "${l[1].value}"`);
                        if (l[2].type === "capture") {
                          const w = l[1].name, M = l[2].name;
                          E[i].push(function(R) {
                            let I, v;
                            for (const A of R)
                              A.name === w && (I = A.node), A.name === M && (v = A.node);
                            return I === void 0 || v === void 0 || I.text === v.text === T;
                          });
                        } else {
                          const w = l[1].name, M = l[2].value;
                          E[i].push(function(R) {
                            for (const I of R)
                              if (I.name === w)
                                return I.node.text === M === T;
                            return !0;
                          });
                        }
                        break;
                      ...
                      case "match?":
                        if (l.length !== 3)
                          throw new Error(`Wrong number of arguments to \`#match?\` predicate. Expected 2, got ${l.length - 1}.`);
                        if (l[1].type !== "capture")
                          throw new Error(`First argument of \`#match?\` predicate must be a capture. Got "${l[1].value}".`);
                        if (l[2].type !== "string")
                          throw new Error(`Second argument of \`#match?\` predicate must be a string. Got @${l[2].value}.`);
                        const O = l[1].name, x = new RegExp(l[2].value);
                        E[i].push(function(w) {
                          for (const M of w)
                            if (M.name === O)
                              return x.test(M.node.text) === T;
                          return !0;
                        });
                        break;
                      case "set!":
                        ...
                        if (l.some((w) => w.type !== "string"))
                          throw new Error('Arguments to `#set!` predicate must be a strings.".');
                        c[i] || (c[i] = {}), c[i][l[1].value] = l[2] ? l[2].value : null;
                        break;
                      case "is?":
                      case "is-not?":
                        if (l.length < 2 || l.length > 3)
                          throw new Error(`Wrong number of arguments to \`#${S}\` predicate. Expected 1 or 2. Got ${l.length - 1}.`);
                        if (l.some((w) => w.type !== "string"))
                          throw new Error(`Arguments to \`#${S}\` predicate must be a strings.".`);
                        const F = S === "is?" ? m : y;
                        F[i] || (F[i] = {}), F[i][l[1].value] = l[2] ? l[2].value : null;
                        break;
                      default:
                        h[i].push({ operator: S, operands: l.slice(1) });
                    }
                    l.length = 0;
                  }
                }
                Object.freeze(c[i]), Object.freeze(m[i]), Object.freeze(y[i]);
              }
              return C._free(n), new Query(INTERNAL, a, d, E, h, Object.freeze(c), Object.freeze(m), Object.freeze(y));
            }
            static load(e) {
              let r;
              if (e instanceof Uint8Array)
                ...
                if (typeof process < "u" && process.versions && process.versions.node) {
                  const s = require$$0;
                  r = Promise.resolve(s.readFileSync(a));
                } else
                  r = fetch(a).then((s) => s.arrayBuffer().then((_) => {
                    if (s.ok)
                      return new Uint8Array(_);
                    {
                      const o = new TextDecoder("utf-8").decode(_);
                      throw new Error(`Language.load failed with status ${s.status}.

${o}`);
                    }
                  }));
              }
              const n = typeof loadSideModule == "function" ? loadSideModule : loadWebAssemblyModule;
              return r.then((a) => n(a, { loadAsync: !0 })).then((a) => {
                const s = Object.keys(a), _ = s.find((d) => LANGUAGE_FUNCTION_REGEX.test(d) && !d.includes("external_scanner_"));
...
${JSON.stringify(s, null, 2)}`);
          ...
          class Query {
            constructor(e, r, n, a, s, _, o, d) {
              assertInternal(e), this[0] = r, this.captureNames = n, this.textPredicates = a, this.predicates = s, this.setProperties = _, this.assertedProperties = o, this.refutedProperties = d, this.exceededMatchLimit = !1;
            }
            delete() {
              C._ts_query_delete(this[0]), this[0] = 0;
            }
            matches(e, r, n, a) {
              r || (r = ZERO_POINT), n || (n = ZERO_POINT), a || (a = {});
              let s = a.matchLimit;
              if (s === void 0)
                s = 0;
              else if (typeof s != "number")
                throw new Error("Arguments must be numbers");
              marshalNode(e), C._ts_query_matches_wasm(this[0], e.tree[0], r.row, r.column, n.row, n.column, s);
              const _ = getValue(TRANSFER_BUFFER, "i32"), o = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32"), d = getValue(TRANSFER_BUFFER + 2 * SIZE_OF_INT, "i32"), u = new Array(_);
              this.exceededMatchLimit = !!d;
              let c = 0, m = o;
              for (let y = 0; y < _; y++) {
                const h = getValue(m, "i32");
                m += SIZE_OF_INT;
                const E = getValue(m, "i32");
                m += SIZE_OF_INT;
                const i = new Array(E);
                if (m = unmarshalCaptures(this, e.tree, m, i), this.textPredicates[h].every((p) => p(i))) {
                  u[c++] = { pattern: h, captures: i };
                  const p = this.setProperties[h];
                  p && (u[y].setProperties = p);
                  const f = this.assertedProperties[h];
                  f && (u[y].assertedProperties = f);
                  const l = this.refutedProperties[h];
                  l && (u[y].refutedProperties = l);
                }
              }
              return u.length = c, C._free(o), u;
            }
            captures(e, r, n, a) {
              r || (r = ZERO_POINT), n || (n = ZERO_POINT), a || (a = {});
              let s = a.matchLimit;
              if (s === void 0)
                ...
                throw new Error("Arguments must be numbers");
              marshalNode(e), C._ts_query_captures_wasm(this[0], e.tree[0], r.row, r.column, n.row, n.column, s);
              const _ = getValue(TRANSFER_BUFFER, "i32"), o = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32"), d = getValue(TRANSFER_BUFFER + 2 * SIZE_OF_INT, "i32"), u = [];
              this.exceededMatchLimit = !!d;
              const c = [];
              let m = o;
              for (let y = 0; y < _; y++) {
                ...
                const E = getValue(m, "i32");
                m += SIZE_OF_INT;
                const i = getValue(m, "i32");
                if (m += SIZE_OF_INT, c.length = E, m = unmarshalCaptures(this, e.tree, m, c), this.textPredicates[h].every((p) => p(c))) {
                  const p = c[i], f = this.setProperties[h];
                  f && (p.setProperties = f);
                  const l = this.assertedProperties[h];
                  l && (p.assertedProperties = l);
                  const g = this.refutedProperties[h];
                  g && (p.refutedProperties = g), u.push(p);
                }
              }
              return C._free(o), u;
            }
          ...
          function getText(t, e, r) {
            const n = r - e;
            let a = t.textCallback(e, null, r);
            for (e += a.length; e < r; ) {
              const s = t.textCallback(e, null, r);
              if (!(s && s.length > 0))
                break;
              e += s.length, a += s;
            }
            return e > r && (a = a.slice(0, n)), a;
          }
          function unmarshalCaptures(t, e, r, n) {
            for (let a = 0, s = n.length; a < s; a++) {
              const _ = getValue(r, "i32"), o = unmarshalNode(e, r += SIZE_OF_INT);
              r += SIZE_OF_NODE, n[a] = { name: t.captureNames[_], node: o };
            }
            return r;
          }
          ...
          function marshalNode(t) {
            ...
            setValue(e, t.id, "i32"), e += SIZE_OF_INT, setValue(e, t.startIndex, "i32"), e += SIZE_OF_INT, setValue(e, t.startPosition.row, "i32"), e += SIZE_OF_INT, setValue(e, t.startPosition.column, "i32"), e += SIZE_OF_INT, setValue(e, t[0], "i32");
          }
          function unmarshalNode(t, e = TRANSFER_BUFFER) {
            const r = getValue(e, "i32");
            if (r === 0)
              return null;
            const n = getValue(e += SIZE_OF_INT, "i32"), a = getValue(e += SIZE_OF_INT, "i32"), s = getValue(e += SIZE_OF_INT, "i32"), _ = getValue(e += SIZE_OF_INT, "i32"), o = new Node(INTERNAL, t);
            return o.id = r, o.startIndex = n, o.startPosition = { row: a, column: s }, o[0] = _, o;
          }
          function marshalTreeCursor(t, e = TRANSFER_BUFFER) {
            setValue(e + 0 * SIZE_OF_INT, t[0], "i32"), setValue(e + 1 * SIZE_OF_INT, t[1], "i32"), setValue(e + 2 * SIZE_OF_INT, t[2], "i32");
          }
          function unmarshalTreeCursor(t) {
            t[0] = getValue(TRANSFER_BUFFER + 0 * SIZE_OF_INT, "i32"), t[1] = getValue(TRANSFER_BUFFER + 1 * SIZE_OF_INT, "i32"), t[2] = getValue(TRANSFER_BUFFER + 2 * SIZE_OF_INT, "i32");
          }
          ...
          function marshalRange(t, e) {
            marshalPoint(t, e.startPosition), marshalPoint(t += SIZE_OF_POINT, e.endPosition), setValue(t += SIZE_OF_POINT, e.startIndex, "i32"), setValue(t += SIZE_OF_INT, e.endIndex, "i32"), t += SIZE_OF_INT;
          }
          function unmarshalRange(t) {
            const e = {};
            return e.startPosition = unmarshalPoint(t), t += SIZE_OF_POINT, e.endPosition = unmarshalPoint(t), t += SIZE_OF_POINT, e.startIndex = getValue(t, "i32"), t += SIZE_OF_INT, e.endIndex = getValue(t, "i32"), e;
          }
          function marshalEdit(t) {
            let e = TRANSFER_BUFFER;
            marshalPoint(e, t.startPosition), e += SIZE_OF_POINT, marshalPoint(e, t.oldEndPosition), e += SIZE_OF_POINT, marshalPoint(e, t.newEndPosition), e += SIZE_OF_POINT, setValue(e, t.startIndex, "i32"), e += SIZE_OF_INT, setValue(e, t.oldEndIndex, "i32"), e += SIZE_OF_INT, setValue(e, t.newEndIndex, "i32"), e += SIZE_OF_INT;
          }
          for (const t of Object.getOwnPropertyNames(ParserImpl.prototype))
            Object.defineProperty(Parser.prototype, t, { value: ParserImpl.prototype[t], enumerable: !1, writable: !1 });
...
async function _loadParser() {
  ...
  const t = new Parser(), e = await Parser.Language.load(`${base}tree-sitter-haskell.wasm`);
  return t.setLanguage(e), t;
}
let parserLoaded;
function loadParser() {
  return parserLoaded || (parserLoaded = _loadParser()), parserLoaded;
}
async function parse(t) {
  return (await loadParser()).parse(t.replaceAll(`

`, "~~~~").replaceAll(`
`, "").replaceAll("~~~~", `
`));
}
function runApply(t, e, r) {
  if (t.children.length !== 2)
    throw new Error(`expected 2 children for node type apply, got ${t.children.length}`);
  const [n, a] = t.children.map((s) => run(s, e, r));
  if (typeof n != "function")
    throw new Error(`${t.children[0].text} is not a function`);
  return n(a);
}
function runInfix(t, e, r, n) {
  const a = n[e];
  if (a)
    return a(t, r);
  switch (e) {
    ...
    case "$":
      return t(r);
    case "&":
      return console.log("right", r), r(t);
    case ".":
      return (s) => t(r(s));
    default:
      throw new Error("unexpected infix operator " + e);
  }
}
function curry(t, e, r, n) {
  const [a, ...s] = t;
  return (_) => {
    let o = { ...r, [a.text]: _ };
    return t.length === 1 ? run(e, o, n) : curry(s, e, o, n);
  };
}
function run(t, e, r = {}) {
  let n = (a, s = e) => run(a, s, r);
  switch (t.type) {
    case "ERROR":
      throw new Error(`invalid syntax: "${t.text}"`);
    case "declarations":
      let a;
      return t.children.forEach((p) => {
        a = n(p);
      }), a;
    case "integer":
    ...
    case "float":
      return Number(t.text);
    case "string":
      const s = t.text.slice(1, -1);
      return String(s);
    case "lambda":
      const [_, o, d, u] = t.children;
      return curry(o.children, u, e, r);
    case "function":
      const [c, m, y] = t.children;
      return e[c.text] = curry(m.children, y, e, r), e[c.text];
    case "list":
      return t.children.filter((p, f) => f % 2 === 1).map((p) => n(p));
    case "match":
      if (t.children[0].text !== "=" || t.children.length !== 2)
        throw new Error("match node so far only support simple assignments");
      return n(t.children[1]);
    case "bind":
      if (t.children.length !== 2)
        throw new Error("expected 2 children for node type bind");
      if (t.children[0].type !== "variable")
        throw new Error("expected variable as first child of bind node");
      if (t.children[1].type !== "match")
        throw new Error("expected match as first child of bind node");
      const [h, E] = t.children, i = n(E);
      return e[h.text] = i, i;
    case "variable":
      return e[t.text];
    case "infix": {
      const [p, f, l] = t.children, g = f.text, [b, N] = [n(p), n(l)];
      return runInfix(b, g, N, r);
    }
    case "apply":
      return runApply(t, e, r);
    case "left_section": {
      const [p, f, l] = t.children, g = n(f);
      return (b) => runInfix(b, l.text, g, r);
    }
    case "right_section": {
      const [p, f, l] = t.children, g = n(l);
      return (b) => runInfix(b, f.text, g, r);
    }
    case "parens":
    ...
    default:
      if (t.children.length === 0)
        throw new Error("unhandled leaf type " + t.type);
      if (t.children.length > 1)
        throw new Error("unhandled branch type " + t.type);
      return n(t.children[0]);
  }
}
async function evaluate(t, e = globalThis, r) {
  const n = await parse(t);
  return run(n.rootNode, e, r);
}
export {
  evaluate,
  loadParser,
